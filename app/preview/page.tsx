// 컴포넌트 프리뷰 갤러리 — docs/FRONTEND_TASK.md Phase별 개발 중 시각
...
// 컴포넌트 렌더링으로 교체한다 (docs/FRONTEND_TASK.md 체크리스트 참고).
    ...
    <main className="mx-auto flex max-w-4xl flex-col gap-8 p-8">
      <header>
        ...
        <p className="mt-1 text-sm text-text-muted">
          docs/FRONTEND_TASK.md의 Phase 순서대로 컴포넌트를 이 페이지에
      ...
      <PreviewSection title="Phase 1: Badge / Button">
        <EmptyPlaceholder note="src/client/components/ui/Badge.tsx, Button.tsx 구현 후 여기에 렌더링" />
      </PreviewSection>

      {/* Phase 2 — Modal, ConfirmDialog */}
      <PreviewSection title="Phase 2: Modal / ConfirmDialog">
        <EmptyPlaceholder note="src/client/components/ui/Modal.tsx, ConfirmDialog.tsx 구현 후 여기에 렌더링" />
      </PreviewSection>
